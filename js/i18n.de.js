/* Generato da build/genera.js: le traduzioni per "de".
   Non modificarlo a mano, le traduzioni stanno in js/i18n.js. */
const LINGUE_PDFAXIOM = ["en","it","es","de","zh","ro","hi","ru"];

const translations = {"en":{"heroTitle":"PDFAXIOM All in One","heroDesc":"Convert, edit, compress and secure your PDF files in seconds, no signup needed.","heroSubtext":"","navConvert":"Convert PDF","navMergeSplit":"Merge & Split","navEdit":"Edit & Security","navCompress":"Compress PDF","navImages":"Image Tools","mobileMenu":"Tools","mobileClose":"Close","tabAll":"All Tools","tabConvert":"Convert & Office","tabOrganize":"Merge & Organize","tabSecurity":"Security & Edit","dragTitle":"Drag & Drop files here","dragSub":"Multiple files • Up to 100 MB each","backBtn":"Back to All Tools","processBtn":"Process PDF","readyTitle":"File is ready!","readySub":"Your file is ready to download.","downloadBtn":"Download File","resetBtn":"Convert Another File","footerCopy":"© 2026 PDFAxiom. Free • No signup required.","extTitle":"PDFAxiom for Chrome","extSub":"Your tools one click away, in every tab.","extBtn":"Add to Chrome"},"de":{"heroTitle":"PDFAXIOM Alles in Einem","heroDesc":"Konvertieren, bearbeiten, komprimieren und schützen Sie Ihre PDFs in Sekundenschnelle, ohne Registrierung.","heroSubtext":"","navConvert":"PDF Konvertieren","navMergeSplit":"Zusammenfügen & Teilen","navEdit":"Bearbeiten & Sicherheit","navCompress":"PDF Komprimieren","navImages":"Bild-Werkzeuge","mobileMenu":"Werkzeuge","mobileClose":"Schließen","tabAll":"Alle Werkzeuge","tabConvert":"Konvertieren & Office","tabOrganize":"Organisieren & Teilen","tabSecurity":"Sicherheit & Bearbeiten","dragTitle":"Dateien hierhin ziehen","dragSub":"Mehrere Dateien • Bis zu 100 MB pro Datei","backBtn":"Zurück zu allen Werkzeugen","processBtn":"PDF Verarbeiten","readyTitle":"Datei ist fertig!","readySub":"Ihre Datei steht zum Download bereit.","downloadBtn":"Datei Herunterladen","resetBtn":"Weitere Datei Konvertieren","footerCopy":"© 2026 PDFAxiom. Kostenlos • Ohne Anmeldung.","extTitle":"PDFAxiom für Chrome","extSub":"Deine Werkzeuge nur einen Klick entfernt, in jedem Tab.","extBtn":"Zu Chrome hinzufügen"}};
const toolTranslations = {"en":{"pdf-to-word":{"title":"PDF to Word","desc":"Convert PDF files to editable Word documents (.docx)."},"word-to-pdf":{"title":"Word to PDF","desc":"Convert Word documents (.docx) to PDF format."},"img-to-pdf":{"title":"Images to PDF","desc":"Convert JPG, PNG, WEBP images into a PDF document."},"pdf-to-img":{"title":"PDF to JPG / PNG","desc":"Extract PDF pages into high-resolution JPG or PNG images."},"merge":{"title":"Merge PDF","desc":"Combine multiple PDF files into one single document."},"compress":{"title":"Compress PDF","desc":"Reduce PDF file size while maintaining maximum quality."},"split":{"title":"Split PDF","desc":"Separate PDF pages or extract custom page ranges."},"delete-pages":{"title":"Delete Pages","desc":"Remove unwanted pages from a PDF document."},"pdf-to-excel":{"title":"PDF to Excel","desc":"Extract PDF tables into Excel (.xlsx / .csv)."},"excel-to-pdf":{"title":"Excel to PDF","desc":"Convert Excel spreadsheets (.xlsx) to PDF."},"pdf-to-pptx":{"title":"PDF to PowerPoint","desc":"Turn PDF pages into PowerPoint slides (.pptx)."},"pptx-to-pdf":{"title":"PowerPoint to PDF","desc":"Convert PowerPoint (.pptx) into PDF file."},"unlock":{"title":"Unlock PDF","desc":"Remove security passwords & restrictions from PDF."},"protect":{"title":"Protect PDF","desc":"Encrypt PDF with custom user password."},"rotate":{"title":"Rotate PDF","desc":"Rotate PDF pages 90°, 180°, or 270° degrees."},"page-numbers":{"title":"Page Numbers","desc":"Add page numbers into your PDF document header/footer."},"watermark":{"title":"Watermark PDF","desc":"Add custom text watermark across PDF pages."},"grayscale":{"title":"Grayscale PDF","desc":"Convert colored PDF documents into Black & White."},"pdf-to-html":{"title":"PDF to HTML","desc":"Convert PDF documents into web-ready HTML code."},"html-to-pdf":{"title":"HTML to PDF","desc":"Convert web HTML text code into a PDF file."},"pdf-to-md":{"title":"PDF to Markdown","desc":"Convert PDF into clean Markdown (.md) for LLMs & Notion."},"md-to-pdf":{"title":"Markdown to PDF","desc":"Convert Markdown (.md) files into styled PDF documents."},"pdf-to-text":{"title":"Extract Text","desc":"Extract plain raw text (.txt) content from PDF."},"extract-images":{"title":"Extract Images","desc":"Extract all embedded image assets inside PDF."}},"de":{"pdf-to-word":{"title":"PDF in Word","desc":"Konvertieren Sie PDF-Dateien in bearbeitbare Word-Dokumente (.docx)."},"word-to-pdf":{"title":"Word in PDF","desc":"Konvertieren Sie Word-Dokumente (.docx) in das PDF-Format."},"img-to-pdf":{"title":"Bilder in PDF","desc":"Konvertieren Sie JPG, PNG, WEBP Bilder in ein PDF-Dokument."},"pdf-to-img":{"title":"PDF in JPG / PNG","desc":"Extrahieren Sie PDF-Seiten als hochauflösende Bilder."},"merge":{"title":"PDF Zusammenfügen","desc":"Kombinieren Sie mehrere PDF-Dateien zu einem Dokument."},"compress":{"title":"PDF Komprimieren","desc":"Reduzieren Sie die PDF-Dateigröße bei maximaler Qualität."},"split":{"title":"PDF Teilen","desc":"Trennen Sie PDF-Seiten oder extrahieren Sie Seitenbereiche."},"delete-pages":{"title":"Seiten Löschen","desc":"Entfernen Sie unerwünschte Seiten aus Ihrem PDF-Dokument."},"pdf-to-excel":{"title":"PDF in Excel","desc":"Extrahieren Sie PDF-Tabellen in Excel (.xlsx / .csv)."},"excel-to-pdf":{"title":"Excel in PDF","desc":"Konvertieren Sie Excel-Tabellen (.xlsx) in PDF."},"pdf-to-pptx":{"title":"PDF in PowerPoint","desc":"Wandeln Sie PDF-Seiten in PowerPoint-Folien (.pptx) um."},"pptx-to-pdf":{"title":"PowerPoint in PDF","desc":"Konvertieren Sie PowerPoint-Präsentationen (.pptx) in PDF."},"unlock":{"title":"PDF Entsperren","desc":"Entfernen Sie Passwörter und Einschränkungen aus PDFs."},"protect":{"title":"PDF Schützen","desc":"Verschlüsseln Sie Ihr PDF mit einem benutzerdefinierten Passwort."},"rotate":{"title":"PDF Drehen","desc":"Drehen Sie PDF-Seiten um 90°, 180° oder 270°."},"page-numbers":{"title":"Seitenzahlen","desc":"Fügen Sie Seitenzahlen in Kopf- oder Fußzeile ein."},"watermark":{"title":"PDF Wasserzeichen","desc":"Fügen Sie ein benutzerdefiniertes Text-Wasserzeichen hinzu."},"grayscale":{"title":"PDF Schwarz-Weiß","desc":"Konvertieren Sie farbige PDFs in Schwarz-Weiß (Graustufen)."},"pdf-to-html":{"title":"PDF in HTML","desc":"Konvertieren Sie PDF-Dokumente in HTML-Webcode."},"html-to-pdf":{"title":"HTML in PDF","desc":"Konvertieren Sie HTML-Textcode in eine PDF-Datei."},"pdf-to-md":{"title":"PDF in Markdown","desc":"Konvertieren Sie PDF in sauberes Markdown (.md) für KI."},"md-to-pdf":{"title":"Markdown in PDF","desc":"Konvertieren Sie Markdown-Dateien in gestylte PDF-Dokumente."},"pdf-to-text":{"title":"Text Extrahieren","desc":"Extrahieren Sie reinen Textinhalt (.txt) aus dem PDF."},"extract-images":{"title":"Bilder Extrahieren","desc":"Extrahieren Sie alle eingebetteten Bilder aus dem PDF."}}};
const toolButtons = {"en":{"pdf-to-word":"Convert PDF to Word","word-to-pdf":"Convert Word to PDF","pdf-to-md":"Convert PDF to Markdown","md-to-pdf":"Convert Markdown to PDF","merge":"Merge PDFs","pdf-to-img":"Convert to Images","img-to-pdf":"Create PDF","compress":"Compress PDF","split":"Split PDF","pdf-to-excel":"Convert to Excel","excel-to-pdf":"Convert Excel to PDF","pdf-to-pptx":"Convert to PowerPoint","pptx-to-pdf":"Convert PowerPoint to PDF","page-numbers":"Add Page Numbers","rotate":"Rotate PDF","unlock":"Unlock PDF","delete-pages":"Delete Pages","pdf-to-html":"Convert to HTML","html-to-pdf":"Convert HTML to PDF","grayscale":"Convert to Grayscale","extract-images":"Extract Images","pdf-to-text":"Extract Text","protect":"Protect PDF","watermark":"Add Watermark"},"de":{"pdf-to-word":"PDF in Word umwandeln","word-to-pdf":"Word in PDF umwandeln","pdf-to-md":"PDF in Markdown umwandeln","md-to-pdf":"Markdown in PDF umwandeln","merge":"PDFs zusammenfügen","pdf-to-img":"In Bilder umwandeln","img-to-pdf":"PDF erstellen","compress":"PDF verkleinern","split":"PDF aufteilen","pdf-to-excel":"In Excel umwandeln","excel-to-pdf":"Excel in PDF umwandeln","pdf-to-pptx":"In PowerPoint umwandeln","pptx-to-pdf":"PowerPoint in PDF umwandeln","page-numbers":"Seitenzahlen einfügen","rotate":"PDF drehen","unlock":"PDF entsperren","delete-pages":"Seiten löschen","pdf-to-html":"In HTML umwandeln","html-to-pdf":"HTML in PDF umwandeln","grayscale":"In Schwarzweiß umwandeln","extract-images":"Bilder extrahieren","pdf-to-text":"Text extrahieren","protect":"PDF schützen","watermark":"Wasserzeichen einfügen"}};
const uiMessages = {"en":{"errGenerico":"Something went wrong. Please try again.","menuDaPdf":"CONVERT FROM PDF","menuAPdf":"CONVERT TO PDF","chiSiamo":"About Us","missioneTitolo":"Our Mission","missioneTesto":"PDFAxiom offers a free PDF suite, accessible from any device without registration.","privacyTitolo":"How we handle your files","privacyTesto":"Most tools process your documents directly in your browser: those files never leave your device. The heavier conversions (Word, Excel, PowerPoint, HTML, compression, protection) run on our servers: the file is processed and deleted immediately afterwards, never stored or shared.","contattiTitolo":"Contact &amp; Support","contattiTesto":"Have questions, suggestions, or requests? Write to us at {email}.","badgePopolare":"POPULAR","badgeOffice":"OFFICE","badgeSlides":"SLIDES","badgeAi":"AI READY","badgeImmagini":"IMAGES","pubblicita":"ADVERTISEMENT","pubblicitaBreve":"AD","piedeGratis":"Free • No signup required.","piedePrivacy":"Privacy","piedeTermini":"Terms","impCompressione":"Compression level","impLeggera":"Light","impLeggeraNota":"Keeps print quality","impMedia":"Balanced","impMediaNota":"Great for print &amp; sharing","impMassima":"Maximum","impMassimaNota":"Smallest file, screen &amp; email","impConsigliata":"Recommended","impPagineEstrai":"Pages to extract (e.g. 1-3, 5)","impPagineElimina":"Pages to delete (e.g. 1, 3)","impPasswordNuova":"Set PDF password","impPasswordAttuale":"Current PDF password","impPasswordSegno":"Enter password","impFiligrana":"Watermark text","rotLabel":"Rotation","rot90r":"90&deg; right","rot90rNota":"Quarter turn clockwise","rot180":"180&deg;","rot180Nota":"Upside down","rot90l":"90&deg; left","rot90lNota":"Quarter turn anticlockwise","numLabel":"Number format","numSolo":"Number only","numSoloNota":"1, 2, 3…","numTotale":"With total","numTotaleNota":"Shows how many","numTrattini":"Dashes","numTrattiniNota":"Classic book style","numEsteso":"Spelled out","numEstesoNota":"In English","uploading":"Uploading file...","processing":"Converting... {s}s","done":"Completed","processingFiles":"Processing files...","merging":"Merging PDF files... {s}%","fromImages":"Creating PDF from images... {s}%","batch":"Converting file {i} of {n}: {name}","zipping":"Creating ZIP package...","success":"Conversion completed successfully!","errTooBig":"File too large ({size}). The limit is 100 MB.","errNetwork":"Could not reach the conversion server.","errTimeout":"The server took too long. Try a smaller file.","errServer":"Server error ({code}).","errRate":"Too many requests. Wait a minute and try again.","errFormat":"The file content does not match the expected format.","errFailed":"Conversion failed: the file may be damaged or protected.","errUnavailable":"Conversion service temporarily unavailable.","errPassword":"Please enter a password.","errFileVuoto":"The file is empty.","errPasswordErrata":"Wrong password.","errTroppePagine":"The document is too long. The limit is 400 pages — split it first and convert the parts.","errPdfIlleggibile":"This PDF cannot be read. It may be damaged or password-protected.","errNessunaTabella":"No table was found in this PDF. Tables drawn without lines are the hardest to detect.","reading":"Reading the file...","working":"Processing...","generating":"Generating the document...","packaging":"Packaging the file...","completed":"Completed!","pageOf":"Page {i} of {n}...","fileOf":"File {i} of {n}..."},"de":{"errGenerico":"Etwas ist schiefgelaufen. Bitte erneut versuchen.","menuDaPdf":"AUS PDF UMWANDELN","menuAPdf":"IN PDF UMWANDELN","chiSiamo":"Über uns","missioneTitolo":"Unsere Mission","missioneTesto":"PDFAxiom bietet eine kostenlose PDF-Sammlung, von jedem Gerät aus und ohne Anmeldung nutzbar.","privacyTitolo":"Wie wir mit Ihren Dateien umgehen","privacyTesto":"Die meisten Werkzeuge verarbeiten Ihre Dokumente direkt im Browser: Diese Dateien verlassen Ihr Gerät nie. Die aufwendigeren Umwandlungen (Word, Excel, PowerPoint, HTML, Komprimierung, Schutz) laufen auf unseren Servern: Die Datei wird verarbeitet und unmittelbar danach gelöscht, niemals gespeichert oder weitergegeben.","contattiTitolo":"Kontakt und Support","contattiTesto":"Fragen, Vorschläge oder Wünsche? Schreiben Sie uns an {email}.","badgePopolare":"BELIEBT","badgeOffice":"OFFICE","badgeSlides":"FOLIEN","badgeAi":"KI-BEREIT","badgeImmagini":"BILDER","pubblicita":"WERBUNG","pubblicitaBreve":"ANZ.","piedeGratis":"Kostenlos • Keine Anmeldung nötig.","piedePrivacy":"Datenschutz","piedeTermini":"Bedingungen","impCompressione":"Komprimierungsgrad","impLeggera":"Leicht","impLeggeraNota":"Behält die Druckqualität","impMedia":"Ausgewogen","impMediaNota":"Gut zum Drucken und Teilen","impMassima":"Maximal","impMassimaNota":"Kleinste Datei, Bildschirm und E-Mail","impConsigliata":"Empfohlen","impPagineEstrai":"Zu extrahierende Seiten (z. B. 1-3, 5)","impPagineElimina":"Zu löschende Seiten (z. B. 1, 3)","impPasswordNuova":"PDF-Passwort festlegen","impPasswordAttuale":"Aktuelles PDF-Passwort","impPasswordSegno":"Passwort eingeben","impFiligrana":"Text des Wasserzeichens","rotLabel":"Drehung","rot90r":"90&deg; rechts","rot90rNota":"Vierteldrehung im Uhrzeigersinn","rot180":"180&deg;","rot180Nota":"Kopfüber","rot90l":"90&deg; links","rot90lNota":"Vierteldrehung gegen den Uhrzeigersinn","numLabel":"Zahlenformat","numSolo":"Nur die Zahl","numSoloNota":"1, 2, 3…","numTotale":"Mit Gesamtzahl","numTotaleNota":"Zeigt wie viele","numTrattini":"Mit Strichen","numTrattiniNota":"Klassischer Buchstil","numEsteso":"Ausgeschrieben","numEstesoNota":"Auf Englisch","uploading":"Datei wird hochgeladen...","processing":"Konvertierung läuft... {s}s","done":"Fertig","processingFiles":"Dateien werden verarbeitet...","merging":"PDFs werden zusammengefügt... {s}%","fromImages":"PDF wird aus Bildern erstellt... {s}%","batch":"Datei {i} von {n} wird konvertiert: {name}","zipping":"ZIP-Paket wird erstellt...","success":"Konvertierung erfolgreich abgeschlossen!","errTooBig":"Datei zu groß ({size}). Das Limit beträgt 100 MB.","errNetwork":"Konvertierungsserver nicht erreichbar.","errTimeout":"Der Server hat zu lange gebraucht. Versuchen Sie eine kleinere Datei.","errServer":"Serverfehler ({code}).","errRate":"Zu viele Anfragen. Warten Sie eine Minute.","errFormat":"Der Dateiinhalt entspricht nicht dem erwarteten Format.","errFailed":"Konvertierung fehlgeschlagen: Die Datei ist möglicherweise beschädigt oder geschützt.","errUnavailable":"Konvertierungsdienst vorübergehend nicht verfügbar.","errPassword":"Bitte geben Sie ein Passwort ein.","errFileVuoto":"Die Datei ist leer.","errPasswordErrata":"Falsches Passwort.","errTroppePagine":"Das Dokument ist zu lang. Die Grenze liegt bei 400 Seiten — teilen Sie es und wandeln Sie die Teile um.","errPdfIlleggibile":"Dieses PDF ist nicht lesbar. Es ist möglicherweise beschädigt oder passwortgeschützt.","errNessunaTabella":"In diesem PDF wurde keine Tabelle gefunden. Tabellen ohne gezeichnete Linien sind am schwersten zu erkennen.","reading":"Datei wird gelesen...","working":"Wird verarbeitet...","generating":"Dokument wird erstellt...","packaging":"Datei wird erstellt...","completed":"Fertig!","pageOf":"Seite {i} von {n}...","fileOf":"Datei {i} von {n}..."}};
