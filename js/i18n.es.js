/* Generato da build/genera.js: le traduzioni per "es".
   Non modificarlo a mano, le traduzioni stanno in js/i18n.js. */
const LINGUE_PDFAXIOM = ["en","it","es","de","zh","ro","hi","ru"];

const translations = {"en":{"heroTitle":"PDFAXIOM All in One","heroDesc":"Convert, edit, compress and secure your PDF files in seconds, no signup needed.","heroSubtext":"","navConvert":"Convert PDF","navMergeSplit":"Merge & Split","navEdit":"Edit & Security","navCompress":"Compress PDF","navImages":"Image Tools","mobileMenu":"Tools","mobileClose":"Close","tabAll":"All Tools","tabConvert":"Convert & Office","tabOrganize":"Merge & Organize","tabSecurity":"Security & Edit","dragTitle":"Drag & Drop files here","dragSub":"Multiple files • Up to 100 MB each","backBtn":"Back to All Tools","processBtn":"Process PDF","readyTitle":"File is ready!","readySub":"Your file is ready to download.","downloadBtn":"Download File","resetBtn":"Convert Another File","footerCopy":"© 2026 PDFAxiom. Free • No signup required.","extTitle":"PDFAxiom for Chrome","extSub":"Your tools one click away, in every tab.","extBtn":"Add to Chrome"},"es":{"heroTitle":"PDFAXIOM Todo en Uno","heroDesc":"Convierte, edita, comprime y protege tus archivos PDF en segundos, sin registro.","heroSubtext":"","navConvert":"Convertir PDF","navMergeSplit":"Unir y Dividir","navEdit":"Edición y Seguridad","navCompress":"Comprimir PDF","navImages":"Herramientas Imagen","mobileMenu":"Herramientas","mobileClose":"Cerrar","tabAll":"Todas las Herramientas","tabConvert":"Conversión y Office","tabOrganize":"Unir y Organizar","tabSecurity":"Seguridad y Edición","dragTitle":"Arrastra y suelta archivos aquí","dragSub":"Varios archivos • Hasta 100 MB cada uno","backBtn":"Volver a Todas las Herramientas","processBtn":"Procesar PDF","readyTitle":"¡El archivo está listo!","readySub":"Tu archivo está listo para descargar.","downloadBtn":"Descargar Archivo","resetBtn":"Convertir Otro Archivo","footerCopy":"© 2026 PDFAxiom. Gratis • Sin registro.","extTitle":"PDFAxiom para Chrome","extSub":"Tus herramientas a un clic, en cada pestaña.","extBtn":"Añadir a Chrome"}};
const toolTranslations = {"en":{"pdf-to-word":{"title":"PDF to Word","desc":"Convert PDF files to editable Word documents (.docx)."},"word-to-pdf":{"title":"Word to PDF","desc":"Convert Word documents (.docx) to PDF format."},"img-to-pdf":{"title":"Images to PDF","desc":"Convert JPG, PNG, WEBP images into a PDF document."},"pdf-to-img":{"title":"PDF to JPG / PNG","desc":"Extract PDF pages into high-resolution JPG or PNG images."},"merge":{"title":"Merge PDF","desc":"Combine multiple PDF files into one single document."},"compress":{"title":"Compress PDF","desc":"Reduce PDF file size while maintaining maximum quality."},"split":{"title":"Split PDF","desc":"Separate PDF pages or extract custom page ranges."},"delete-pages":{"title":"Delete Pages","desc":"Remove unwanted pages from a PDF document."},"pdf-to-excel":{"title":"PDF to Excel","desc":"Extract PDF tables into Excel (.xlsx / .csv)."},"excel-to-pdf":{"title":"Excel to PDF","desc":"Convert Excel spreadsheets (.xlsx) to PDF."},"pdf-to-pptx":{"title":"PDF to PowerPoint","desc":"Turn PDF pages into PowerPoint slides (.pptx)."},"pptx-to-pdf":{"title":"PowerPoint to PDF","desc":"Convert PowerPoint (.pptx) into PDF file."},"unlock":{"title":"Unlock PDF","desc":"Remove security passwords & restrictions from PDF."},"protect":{"title":"Protect PDF","desc":"Encrypt PDF with custom user password."},"rotate":{"title":"Rotate PDF","desc":"Rotate PDF pages 90°, 180°, or 270° degrees."},"page-numbers":{"title":"Page Numbers","desc":"Add page numbers into your PDF document header/footer."},"watermark":{"title":"Watermark PDF","desc":"Add custom text watermark across PDF pages."},"grayscale":{"title":"Grayscale PDF","desc":"Convert colored PDF documents into Black & White."},"pdf-to-html":{"title":"PDF to HTML","desc":"Convert PDF documents into web-ready HTML code."},"html-to-pdf":{"title":"HTML to PDF","desc":"Convert web HTML text code into a PDF file."},"pdf-to-md":{"title":"PDF to Markdown","desc":"Convert PDF into clean Markdown (.md) for LLMs & Notion."},"md-to-pdf":{"title":"Markdown to PDF","desc":"Convert Markdown (.md) files into styled PDF documents."},"pdf-to-text":{"title":"Extract Text","desc":"Extract plain raw text (.txt) content from PDF."},"extract-images":{"title":"Extract Images","desc":"Extract all embedded image assets inside PDF."}},"es":{"pdf-to-word":{"title":"PDF a Word","desc":"Convierte archivos PDF a documentos Word editables (.docx)."},"word-to-pdf":{"title":"Word a PDF","desc":"Convierte documentos Word (.docx) a formato PDF."},"img-to-pdf":{"title":"Imágenes a PDF","desc":"Convierte imágenes JPG, PNG, WEBP en un documento PDF."},"pdf-to-img":{"title":"PDF a JPG / PNG","desc":"Extrae páginas PDF en imágenes JPG o PNG de alta resolución."},"merge":{"title":"Unir PDF","desc":"Combina múltiples archivos PDF en un solo documento."},"compress":{"title":"Comprimir PDF","desc":"Reduce el tamaño del PDF manteniendo la máxima calidad."},"split":{"title":"Dividir PDF","desc":"Separa páginas PDF o extrae rangos personalizados."},"delete-pages":{"title":"Eliminar Páginas","desc":"Elimina páginas no deseadas de un documento PDF."},"pdf-to-excel":{"title":"PDF a Excel","desc":"Extrae tablas PDF a hojas de cálculo Excel (.xlsx / .csv)."},"excel-to-pdf":{"title":"Excel a PDF","desc":"Convierte hojas de cálculo Excel (.xlsx) a PDF."},"pdf-to-pptx":{"title":"PDF a PowerPoint","desc":"Convierte páginas PDF en diapositivas PowerPoint (.pptx)."},"pptx-to-pdf":{"title":"PowerPoint a PDF","desc":"Convierte presentaciones PowerPoint (.pptx) a PDF."},"unlock":{"title":"Desbloquear PDF","desc":"Elimina contraseñas de seguridad y restricciones de tu PDF."},"protect":{"title":"Proteger PDF","desc":"Encripta tu PDF con una contraseña personalizada."},"rotate":{"title":"Rotar PDF","desc":"Gira las páginas del PDF 90°, 180° o 270°."},"page-numbers":{"title":"Números de Página","desc":"Añade números de página en el encabezado o pie de página."},"watermark":{"title":"Marca de Agua PDF","desc":"Añade marca de agua de texto personalizada en tu PDF."},"grayscale":{"title":"PDF Blanco y Negro","desc":"Convierte documentos PDF a color en Blanco y Negro."},"pdf-to-html":{"title":"PDF a HTML","desc":"Convierte documentos PDF a código web HTML."},"html-to-pdf":{"title":"HTML a PDF","desc":"Convierte código texto HTML en un archivo PDF."},"pdf-to-md":{"title":"PDF a Markdown","desc":"Convierte PDF a Markdown (.md) limpio para IA y Notion."},"md-to-pdf":{"title":"Markdown a PDF","desc":"Convierte archivos Markdown (.md) a PDF estilizados."},"pdf-to-text":{"title":"Extraer Texto","desc":"Extrae el contenido de texto plano (.txt) del PDF."},"extract-images":{"title":"Extraer Imágenes","desc":"Extrae todas las imágenes incrustadas dentro del PDF."}}};
const toolButtons = {"en":{"pdf-to-word":"Convert PDF to Word","word-to-pdf":"Convert Word to PDF","pdf-to-md":"Convert PDF to Markdown","md-to-pdf":"Convert Markdown to PDF","merge":"Merge PDFs","pdf-to-img":"Convert to Images","img-to-pdf":"Create PDF","compress":"Compress PDF","split":"Split PDF","pdf-to-excel":"Convert to Excel","excel-to-pdf":"Convert Excel to PDF","pdf-to-pptx":"Convert to PowerPoint","pptx-to-pdf":"Convert PowerPoint to PDF","page-numbers":"Add Page Numbers","rotate":"Rotate PDF","unlock":"Unlock PDF","delete-pages":"Delete Pages","pdf-to-html":"Convert to HTML","html-to-pdf":"Convert HTML to PDF","grayscale":"Convert to Grayscale","extract-images":"Extract Images","pdf-to-text":"Extract Text","protect":"Protect PDF","watermark":"Add Watermark"},"es":{"pdf-to-word":"Convertir PDF a Word","word-to-pdf":"Convertir Word a PDF","pdf-to-md":"Convertir PDF a Markdown","md-to-pdf":"Convertir Markdown a PDF","merge":"Unir los PDF","pdf-to-img":"Convertir a imágenes","img-to-pdf":"Crear el PDF","compress":"Comprimir el PDF","split":"Dividir el PDF","pdf-to-excel":"Convertir a Excel","excel-to-pdf":"Convertir Excel a PDF","pdf-to-pptx":"Convertir a PowerPoint","pptx-to-pdf":"Convertir PowerPoint a PDF","page-numbers":"Añadir números de página","rotate":"Girar el PDF","unlock":"Desbloquear el PDF","delete-pages":"Eliminar las páginas","pdf-to-html":"Convertir a HTML","html-to-pdf":"Convertir HTML a PDF","grayscale":"Convertir a blanco y negro","extract-images":"Extraer las imágenes","pdf-to-text":"Extraer el texto","protect":"Proteger el PDF","watermark":"Añadir la marca de agua"}};
const uiMessages = {"en":{"errGenerico":"Something went wrong. Please try again.","menuDaPdf":"CONVERT FROM PDF","menuAPdf":"CONVERT TO PDF","chiSiamo":"About Us","missioneTitolo":"Our Mission","missioneTesto":"PDFAxiom offers a free PDF suite, accessible from any device without registration.","privacyTitolo":"How we handle your files","privacyTesto":"Most tools process your documents directly in your browser: those files never leave your device. The heavier conversions (Word, Excel, PowerPoint, HTML, compression, protection) run on our servers: the file is processed and deleted immediately afterwards, never stored or shared.","contattiTitolo":"Contact &amp; Support","contattiTesto":"Have questions, suggestions, or requests? Write to us at {email}.","badgePopolare":"POPULAR","badgeOffice":"OFFICE","badgeSlides":"SLIDES","badgeAi":"AI READY","badgeImmagini":"IMAGES","pubblicita":"ADVERTISEMENT","pubblicitaBreve":"AD","piedeGratis":"Free • No signup required.","piedePrivacy":"Privacy","piedeTermini":"Terms","impCompressione":"Compression level","impLeggera":"Light","impLeggeraNota":"Keeps print quality","impMedia":"Balanced","impMediaNota":"Great for print &amp; sharing","impMassima":"Maximum","impMassimaNota":"Smallest file, screen &amp; email","impConsigliata":"Recommended","impPagineEstrai":"Pages to extract (e.g. 1-3, 5)","impPagineElimina":"Pages to delete (e.g. 1, 3)","impPasswordNuova":"Set PDF password","impPasswordAttuale":"Current PDF password","impPasswordSegno":"Enter password","impFiligrana":"Watermark text","rotLabel":"Rotation","rot90r":"90&deg; right","rot90rNota":"Quarter turn clockwise","rot180":"180&deg;","rot180Nota":"Upside down","rot90l":"90&deg; left","rot90lNota":"Quarter turn anticlockwise","numLabel":"Number format","numSolo":"Number only","numSoloNota":"1, 2, 3…","numTotale":"With total","numTotaleNota":"Shows how many","numTrattini":"Dashes","numTrattiniNota":"Classic book style","numEsteso":"Spelled out","numEstesoNota":"In English","uploading":"Uploading file...","processing":"Converting... {s}s","done":"Completed","processingFiles":"Processing files...","merging":"Merging PDF files... {s}%","fromImages":"Creating PDF from images... {s}%","batch":"Converting file {i} of {n}: {name}","zipping":"Creating ZIP package...","success":"Conversion completed successfully!","errTooBig":"File too large ({size}). The limit is 100 MB.","errNetwork":"Could not reach the conversion server.","errTimeout":"The server took too long. Try a smaller file.","errServer":"Server error ({code}).","errRate":"Too many requests. Wait a minute and try again.","errFormat":"The file content does not match the expected format.","errFailed":"Conversion failed: the file may be damaged or protected.","errUnavailable":"Conversion service temporarily unavailable.","errPassword":"Please enter a password.","errFileVuoto":"The file is empty.","errPasswordErrata":"Wrong password.","errTroppePagine":"The document is too long. The limit is 400 pages — split it first and convert the parts.","errPdfIlleggibile":"This PDF cannot be read. It may be damaged or password-protected.","errNessunaTabella":"No table was found in this PDF. Tables drawn without lines are the hardest to detect.","reading":"Reading the file...","working":"Processing...","generating":"Generating the document...","packaging":"Packaging the file...","completed":"Completed!","pageOf":"Page {i} of {n}...","fileOf":"File {i} of {n}..."},"es":{"errGenerico":"Algo ha salido mal. Inténtalo de nuevo.","menuDaPdf":"CONVERTIR DESDE PDF","menuAPdf":"CONVERTIR A PDF","chiSiamo":"Sobre nosotros","missioneTitolo":"Nuestra misión","missioneTesto":"PDFAxiom ofrece un conjunto de herramientas PDF gratuito, accesible desde cualquier dispositivo y sin registro.","privacyTitolo":"Cómo tratamos tus archivos","privacyTesto":"La mayoría de las herramientas procesa los documentos directamente en tu navegador: esos archivos nunca salen de tu dispositivo. Las conversiones más pesadas (Word, Excel, PowerPoint, HTML, compresión, protección) se ejecutan en nuestros servidores: el archivo se procesa y se elimina justo después, sin guardarse ni compartirse.","contattiTitolo":"Contacto y soporte","contattiTesto":"¿Tienes preguntas, sugerencias o peticiones? Escríbenos a {email}.","badgePopolare":"POPULAR","badgeOffice":"OFFICE","badgeSlides":"DIAPOSITIVAS","badgeAi":"LISTO PARA IA","badgeImmagini":"IMÁGENES","pubblicita":"PUBLICIDAD","pubblicitaBreve":"ANUN.","piedeGratis":"Gratis • Sin registro.","piedePrivacy":"Privacidad","piedeTermini":"Términos","impCompressione":"Nivel de compresión","impLeggera":"Ligera","impLeggeraNota":"Mantiene la calidad de impresión","impMedia":"Equilibrada","impMediaNota":"Buena para imprimir y compartir","impMassima":"Máxima","impMassimaNota":"Archivo más pequeño, pantalla y correo","impConsigliata":"Recomendada","impPagineEstrai":"Páginas a extraer (ej. 1-3, 5)","impPagineElimina":"Páginas a eliminar (ej. 1, 3)","impPasswordNuova":"Establece la contraseña del PDF","impPasswordAttuale":"Contraseña actual del PDF","impPasswordSegno":"Introduce la contraseña","impFiligrana":"Texto de la marca de agua","rotLabel":"Rotación","rot90r":"90&deg; a la derecha","rot90rNota":"Un cuarto de vuelta","rot180":"180&deg;","rot180Nota":"Boca abajo","rot90l":"90&deg; a la izquierda","rot90lNota":"Un cuarto en sentido antihorario","numLabel":"Formato del número","numSolo":"Solo el número","numSoloNota":"1, 2, 3…","numTotale":"Con el total","numTotaleNota":"Muestra cuántas son","numTrattini":"Entre guiones","numTrattiniNota":"Estilo libro","numEsteso":"Con palabras","numEstesoNota":"En inglés","uploading":"Subiendo archivo...","processing":"Convirtiendo... {s}s","done":"Completado","processingFiles":"Procesando archivos...","merging":"Uniendo PDF... {s}%","fromImages":"Creando PDF desde imágenes... {s}%","batch":"Convirtiendo archivo {i} de {n}: {name}","zipping":"Creando paquete ZIP...","success":"¡Conversión completada con éxito!","errTooBig":"Archivo demasiado grande ({size}). El límite es 100 MB.","errNetwork":"No se pudo contactar con el servidor de conversión.","errTimeout":"El servidor tardó demasiado. Prueba con un archivo más pequeño.","errServer":"Error del servidor ({code}).","errRate":"Demasiadas solicitudes. Espera un minuto e inténtalo de nuevo.","errFormat":"El contenido del archivo no coincide con el formato esperado.","errFailed":"Conversión fallida: el archivo puede estar dañado o protegido.","errUnavailable":"Servicio de conversión temporalmente no disponible.","errPassword":"Introduce una contraseña.","errFileVuoto":"El archivo está vacío.","errPasswordErrata":"Contraseña incorrecta.","errTroppePagine":"El documento es demasiado largo. El límite son 400 páginas: divídelo y convierte las partes.","errPdfIlleggibile":"Este PDF no se puede leer. Puede estar dañado o protegido con contraseña.","errNessunaTabella":"No se encontró ninguna tabla en este PDF. Las tablas sin líneas son las más difíciles de detectar.","reading":"Leyendo el archivo...","working":"Procesando...","generating":"Generando el documento...","packaging":"Creando el archivo...","completed":"¡Completado!","pageOf":"Página {i} de {n}...","fileOf":"Archivo {i} de {n}..."}};
