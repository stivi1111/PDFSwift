...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const toolsConfig = {
    ...
    'ocr': { title: 'OCR PDF', desc: 'Make a scanned PDF searchable, selectable and copyable.', multiple: false, accept: '.pdf', btnText: 'Make Searchable', outputExt: '_cercabile.pdf' },
