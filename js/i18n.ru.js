/* Generato da build/genera.js: le traduzioni per "ru".
   Non modificarlo a mano, le traduzioni stanno in js/i18n.js. */
const LINGUE_PDFAXIOM = ["en","it","es","de","zh","ro","hi","ru"];

const translations = {"en":{"heroTitle":"PDFAXIOM All in One","heroDesc":"Convert, edit, compress and secure your PDF files in seconds, no signup needed.","heroSubtext":"","navConvert":"Convert PDF","navMergeSplit":"Merge & Split","navEdit":"Edit & Security","navCompress":"Compress PDF","navImages":"Image Tools","mobileMenu":"Tools","mobileClose":"Close","tabAll":"All Tools","tabConvert":"Convert & Office","tabOrganize":"Merge & Organize","tabSecurity":"Security & Edit","dragTitle":"Drag & Drop files here","dragSub":"Multiple files • Up to 100 MB each","backBtn":"Back to All Tools","processBtn":"Process PDF","readyTitle":"File is ready!","readySub":"Your file is ready to download.","downloadBtn":"Download File","resetBtn":"Convert Another File","footerCopy":"© 2026 PDFAxiom. Free • No signup required.","extTitle":"PDFAxiom for Chrome","extSub":"Your tools one click away, in every tab.","extBtn":"Add to Chrome"},"ru":{"heroTitle":"PDFAXIOM Все в Одном","heroDesc":"Конвертируйте, редактируйте, сжимайте и защищайте PDF за секунды, без регистрации.","heroSubtext":"","navConvert":"Конвертировать PDF","navMergeSplit":"Объединить и Разделить","navEdit":"Редактирование и Защита","navCompress":"Сжать PDF","navImages":"Инструменты Изображений","mobileMenu":"Инструменты","mobileClose":"Закрыть","tabAll":"Все Инструменты","tabConvert":"Конвертация и Офис","tabOrganize":"Объединение и Порядок","tabSecurity":"Защита и Редактирование","dragTitle":"Перетащите файлы сюда","dragSub":"Несколько файлов • До 100 МБ каждый","backBtn":"Назад ко всем инструментам","processBtn":"Обработать PDF","readyTitle":"Файл готов!","readySub":"Ваш файл готов к загрузке.","downloadBtn":"Скачать Файл","resetBtn":"Конвертировать Другой Файл","footerCopy":"© 2026 PDFAxiom. Бесплатно • Без регистрации.","extTitle":"PDFAxiom для Chrome","extSub":"Инструменты в одном клике, в любой вкладке.","extBtn":"Добавить в Chrome"}};
const toolTranslations = {"en":{"pdf-to-word":{"title":"PDF to Word","desc":"Convert PDF files to editable Word documents (.docx)."},"word-to-pdf":{"title":"Word to PDF","desc":"Convert Word documents (.docx) to PDF format."},"img-to-pdf":{"title":"Images to PDF","desc":"Convert JPG, PNG, WEBP images into a PDF document."},"pdf-to-img":{"title":"PDF to JPG / PNG","desc":"Extract PDF pages into high-resolution JPG or PNG images."},"merge":{"title":"Merge PDF","desc":"Combine multiple PDF files into one single document."},"compress":{"title":"Compress PDF","desc":"Reduce PDF file size while maintaining maximum quality."},"split":{"title":"Split PDF","desc":"Separate PDF pages or extract custom page ranges."},"delete-pages":{"title":"Delete Pages","desc":"Remove unwanted pages from a PDF document."},"pdf-to-excel":{"title":"PDF to Excel","desc":"Extract PDF tables into Excel (.xlsx / .csv)."},"excel-to-pdf":{"title":"Excel to PDF","desc":"Convert Excel spreadsheets (.xlsx) to PDF."},"pdf-to-pptx":{"title":"PDF to PowerPoint","desc":"Turn PDF pages into PowerPoint slides (.pptx)."},"pptx-to-pdf":{"title":"PowerPoint to PDF","desc":"Convert PowerPoint (.pptx) into PDF file."},"unlock":{"title":"Unlock PDF","desc":"Remove security passwords & restrictions from PDF."},"protect":{"title":"Protect PDF","desc":"Encrypt PDF with custom user password."},"rotate":{"title":"Rotate PDF","desc":"Rotate PDF pages 90°, 180°, or 270° degrees."},"page-numbers":{"title":"Page Numbers","desc":"Add page numbers into your PDF document header/footer."},"watermark":{"title":"Watermark PDF","desc":"Add custom text watermark across PDF pages."},"grayscale":{"title":"Grayscale PDF","desc":"Convert colored PDF documents into Black & White."},"pdf-to-html":{"title":"PDF to HTML","desc":"Convert PDF documents into web-ready HTML code."},"html-to-pdf":{"title":"HTML to PDF","desc":"Convert web HTML text code into a PDF file."},"pdf-to-md":{"title":"PDF to Markdown","desc":"Convert PDF into clean Markdown (.md) for LLMs & Notion."},"md-to-pdf":{"title":"Markdown to PDF","desc":"Convert Markdown (.md) files into styled PDF documents."},"pdf-to-text":{"title":"Extract Text","desc":"Extract plain raw text (.txt) content from PDF."},"extract-images":{"title":"Extract Images","desc":"Extract all embedded image assets inside PDF."}},"ru":{"pdf-to-word":{"title":"PDF в Word","desc":"Конвертируйте PDF в редактируемый Word (.docx)."},"word-to-pdf":{"title":"Word в PDF","desc":"Конвертируйте документы Word (.docx) в PDF."},"img-to-pdf":{"title":"Изображения в PDF","desc":"Конвертируйте JPG, PNG, WEBP в один PDF документ."},"pdf-to-img":{"title":"PDF в JPG / PNG","desc":"Извлекайте страницы PDF в изображения высочайшего качества."},"merge":{"title":"Объединить PDF","desc":"Объединяйте несколько PDF в один файл."},"compress":{"title":"Сжать PDF","desc":"Уменьшайте размер PDF без потери качества."},"split":{"title":"Разделить PDF","desc":"Разделяйте страницы PDF или извлекайте диапазоны."},"delete-pages":{"title":"Удалить Страницы","desc":"Удаляйте ненужные страницы из PDF."},"pdf-to-excel":{"title":"PDF в Excel","desc":"Извлекайте таблицы PDF в Excel (.xlsx / .csv)."},"excel-to-pdf":{"title":"Excel в PDF","desc":"Конвертируйте таблицы Excel (.xlsx) в PDF."},"pdf-to-pptx":{"title":"PDF в PowerPoint","desc":"Превращайте страницы PDF в слайды PowerPoint (.pptx)."},"pptx-to-pdf":{"title":"PowerPoint в PDF","desc":"Конвертируйте презентации PowerPoint (.pptx) в PDF."},"unlock":{"title":"Снять Защиту PDF","desc":"Удаляйте пароли и ограничения безопасности."},"protect":{"title":"Защитить PDF","desc":"Зашифруйте свой PDF персональным паролем."},"rotate":{"title":"Повернуть PDF","desc":"Поворачивайте страницы PDF на 90°, 180° или 270°."},"page-numbers":{"title":"Номера Страниц","desc":"Добавляйте нумерацию страниц в верхний или нижний колонтитул."},"watermark":{"title":"Водяной Знак PDF","desc":"Добавляйте свой текст водяного знака на страницы."},"grayscale":{"title":"Черно-белый PDF","desc":"Конвертируйте цветной PDF в черно-белый формат."},"pdf-to-html":{"title":"PDF в HTML","desc":"Конвертируйте PDF в веб-код HTML."},"html-to-pdf":{"title":"HTML в PDF","desc":"Конвертируйте HTML код в PDF документ."},"pdf-to-md":{"title":"PDF в Markdown","desc":"Конвертируйте PDF в чистый Markdown (.md) для ИИ."},"md-to-pdf":{"title":"Markdown в PDF","desc":"Конвертируйте Markdown (.md) файлы в красивые PDF."},"pdf-to-text":{"title":"Извлечь Текст","desc":"Извлекайте чистый текст (.txt) из PDF."},"extract-images":{"title":"Извлечь Картинки","desc":"Извлекайте все изображения из вашего PDF."}}};
const toolButtons = {"en":{"pdf-to-word":"Convert PDF to Word","word-to-pdf":"Convert Word to PDF","pdf-to-md":"Convert PDF to Markdown","md-to-pdf":"Convert Markdown to PDF","merge":"Merge PDFs","pdf-to-img":"Convert to Images","img-to-pdf":"Create PDF","compress":"Compress PDF","split":"Split PDF","pdf-to-excel":"Convert to Excel","excel-to-pdf":"Convert Excel to PDF","pdf-to-pptx":"Convert to PowerPoint","pptx-to-pdf":"Convert PowerPoint to PDF","page-numbers":"Add Page Numbers","rotate":"Rotate PDF","unlock":"Unlock PDF","delete-pages":"Delete Pages","pdf-to-html":"Convert to HTML","html-to-pdf":"Convert HTML to PDF","grayscale":"Convert to Grayscale","extract-images":"Extract Images","pdf-to-text":"Extract Text","protect":"Protect PDF","watermark":"Add Watermark"},"ru":{"pdf-to-word":"Преобразовать PDF в Word","word-to-pdf":"Преобразовать Word в PDF","pdf-to-md":"Преобразовать PDF в Markdown","md-to-pdf":"Преобразовать Markdown в PDF","merge":"Объединить PDF","pdf-to-img":"Преобразовать в изображения","img-to-pdf":"Создать PDF","compress":"Сжать PDF","split":"Разделить PDF","pdf-to-excel":"Преобразовать в Excel","excel-to-pdf":"Преобразовать Excel в PDF","pdf-to-pptx":"Преобразовать в PowerPoint","pptx-to-pdf":"Преобразовать PowerPoint в PDF","page-numbers":"Добавить номера страниц","rotate":"Повернуть PDF","unlock":"Разблокировать PDF","delete-pages":"Удалить страницы","pdf-to-html":"Преобразовать в HTML","html-to-pdf":"Преобразовать HTML в PDF","grayscale":"Сделать чёрно-белым","extract-images":"Извлечь изображения","pdf-to-text":"Извлечь текст","protect":"Защитить PDF","watermark":"Добавить водяной знак"}};
const uiMessages = {"en":{"errGenerico":"Something went wrong. Please try again.","menuDaPdf":"CONVERT FROM PDF","menuAPdf":"CONVERT TO PDF","chiSiamo":"About Us","missioneTitolo":"Our Mission","missioneTesto":"PDFAxiom offers a free PDF suite, accessible from any device without registration.","privacyTitolo":"How we handle your files","privacyTesto":"Most tools process your documents directly in your browser: those files never leave your device. The heavier conversions (Word, Excel, PowerPoint, HTML, compression, protection) run on our servers: the file is processed and deleted immediately afterwards, never stored or shared.","contattiTitolo":"Contact &amp; Support","contattiTesto":"Have questions, suggestions, or requests? Write to us at {email}.","badgePopolare":"POPULAR","badgeOffice":"OFFICE","badgeSlides":"SLIDES","badgeAi":"AI READY","badgeImmagini":"IMAGES","pubblicita":"ADVERTISEMENT","pubblicitaBreve":"AD","piedeGratis":"Free • No signup required.","piedePrivacy":"Privacy","piedeTermini":"Terms","impCompressione":"Compression level","impLeggera":"Light","impLeggeraNota":"Keeps print quality","impMedia":"Balanced","impMediaNota":"Great for print &amp; sharing","impMassima":"Maximum","impMassimaNota":"Smallest file, screen &amp; email","impConsigliata":"Recommended","impPagineEstrai":"Pages to extract (e.g. 1-3, 5)","impPagineElimina":"Pages to delete (e.g. 1, 3)","impPasswordNuova":"Set PDF password","impPasswordAttuale":"Current PDF password","impPasswordSegno":"Enter password","impFiligrana":"Watermark text","rotLabel":"Rotation","rot90r":"90&deg; right","rot90rNota":"Quarter turn clockwise","rot180":"180&deg;","rot180Nota":"Upside down","rot90l":"90&deg; left","rot90lNota":"Quarter turn anticlockwise","numLabel":"Number format","numSolo":"Number only","numSoloNota":"1, 2, 3…","numTotale":"With total","numTotaleNota":"Shows how many","numTrattini":"Dashes","numTrattiniNota":"Classic book style","numEsteso":"Spelled out","numEstesoNota":"In English","uploading":"Uploading file...","processing":"Converting... {s}s","done":"Completed","processingFiles":"Processing files...","merging":"Merging PDF files... {s}%","fromImages":"Creating PDF from images... {s}%","batch":"Converting file {i} of {n}: {name}","zipping":"Creating ZIP package...","success":"Conversion completed successfully!","errTooBig":"File too large ({size}). The limit is 100 MB.","errNetwork":"Could not reach the conversion server.","errTimeout":"The server took too long. Try a smaller file.","errServer":"Server error ({code}).","errRate":"Too many requests. Wait a minute and try again.","errFormat":"The file content does not match the expected format.","errFailed":"Conversion failed: the file may be damaged or protected.","errUnavailable":"Conversion service temporarily unavailable.","errPassword":"Please enter a password.","errFileVuoto":"The file is empty.","errPasswordErrata":"Wrong password.","errTroppePagine":"The document is too long. The limit is 400 pages — split it first and convert the parts.","errPdfIlleggibile":"This PDF cannot be read. It may be damaged or password-protected.","errNessunaTabella":"No table was found in this PDF. Tables drawn without lines are the hardest to detect.","reading":"Reading the file...","working":"Processing...","generating":"Generating the document...","packaging":"Packaging the file...","completed":"Completed!","pageOf":"Page {i} of {n}...","fileOf":"File {i} of {n}..."},"ru":{"errGenerico":"Что-то пошло не так. Попробуйте ещё раз.","menuDaPdf":"ПРЕОБРАЗОВАТЬ ИЗ PDF","menuAPdf":"ПРЕОБРАЗОВАТЬ В PDF","chiSiamo":"О нас","missioneTitolo":"Наша задача","missioneTesto":"PDFAxiom — бесплатный набор инструментов для PDF, доступный с любого устройства и без регистрации.","privacyTitolo":"Как мы обращаемся с вашими файлами","privacyTesto":"Большинство инструментов обрабатывает документы прямо в браузере: эти файлы никогда не покидают ваше устройство. Более тяжёлые преобразования (Word, Excel, PowerPoint, HTML, сжатие, защита) выполняются на наших серверах: файл обрабатывается и сразу же удаляется, не сохраняясь и не передаваясь.","contattiTitolo":"Контакты и поддержка","contattiTesto":"Есть вопросы, идеи или пожелания? Напишите нам на {email}.","badgePopolare":"ПОПУЛЯРНОЕ","badgeOffice":"OFFICE","badgeSlides":"СЛАЙДЫ","badgeAi":"ГОТОВО ДЛЯ ИИ","badgeImmagini":"ИЗОБРАЖЕНИЯ","pubblicita":"РЕКЛАМА","pubblicitaBreve":"РЕК.","piedeGratis":"Бесплатно • Без регистрации.","piedePrivacy":"Конфиденциальность","piedeTermini":"Условия","impCompressione":"Уровень сжатия","impLeggera":"Лёгкое","impLeggeraNota":"Сохраняет качество печати","impMedia":"Сбалансированное","impMediaNota":"Для печати и отправки","impMassima":"Максимальное","impMassimaNota":"Самый маленький файл, экран и почта","impConsigliata":"Рекомендуется","impPagineEstrai":"Страницы для извлечения (напр. 1-3, 5)","impPagineElimina":"Страницы для удаления (напр. 1, 3)","impPasswordNuova":"Задайте пароль PDF","impPasswordAttuale":"Текущий пароль PDF","impPasswordSegno":"Введите пароль","impFiligrana":"Текст водяного знака","rotLabel":"Поворот","rot90r":"90&deg; вправо","rot90rNota":"Четверть оборота по часовой","rot180":"180&deg;","rot180Nota":"Вверх ногами","rot90l":"90&deg; влево","rot90lNota":"Четверть оборота против часовой","numLabel":"Формат номера","numSolo":"Только номер","numSoloNota":"1, 2, 3…","numTotale":"С общим числом","numTotaleNota":"Показывает, сколько всего","numTrattini":"В тире","numTrattiniNota":"Классический книжный стиль","numEsteso":"Словами","numEstesoNota":"На английском","uploading":"Загрузка файла...","processing":"Конвертация... {s}с","done":"Готово","processingFiles":"Обработка файлов...","merging":"Объединение PDF... {s}%","fromImages":"Создание PDF из изображений... {s}%","batch":"Конвертация файла {i} из {n}: {name}","zipping":"Создание ZIP-архива...","success":"Конвертация успешно завершена!","errTooBig":"Файл слишком большой ({size}). Лимит — 100 МБ.","errNetwork":"Не удалось связаться с сервером конвертации.","errTimeout":"Сервер отвечал слишком долго. Попробуйте файл меньшего размера.","errServer":"Ошибка сервера ({code}).","errRate":"Слишком много запросов. Подождите минуту.","errFormat":"Содержимое файла не соответствует ожидаемому формату.","errFailed":"Конвертация не удалась: файл может быть повреждён или защищён.","errUnavailable":"Служба конвертации временно недоступна.","errPassword":"Введите пароль.","errFileVuoto":"Файл пуст.","errPasswordErrata":"Неверный пароль.","errTroppePagine":"Документ слишком длинный. Предел — 400 страниц: разделите его и конвертируйте части.","errPdfIlleggibile":"Этот PDF не читается. Возможно, он повреждён или защищён паролем.","errNessunaTabella":"В этом PDF таблиц не найдено. Таблицы без нарисованных линий распознать труднее всего.","reading":"Чтение файла...","working":"Обработка...","generating":"Создание документа...","packaging":"Создание файла...","completed":"Готово!","pageOf":"Страница {i} из {n}...","fileOf":"Файл {i} из {n}..."}};
