/* Generato da build/genera.js: le traduzioni per "hi".
   Non modificarlo a mano, le traduzioni stanno in js/i18n.js. */
const LINGUE_PDFAXIOM = ["en","it","es","de","zh","ro","hi","ru"];

const translations = {"en":{"heroTitle":"PDFAXIOM All in One","heroDesc":"Convert, edit, compress and secure your PDF files in seconds, no signup needed.","heroSubtext":"","navConvert":"Convert PDF","navMergeSplit":"Merge & Split","navEdit":"Edit & Security","navCompress":"Compress PDF","navImages":"Image Tools","mobileMenu":"Tools","mobileClose":"Close","tabAll":"All Tools","tabConvert":"Convert & Office","tabOrganize":"Merge & Organize","tabSecurity":"Security & Edit","dragTitle":"Drag & Drop files here","dragSub":"Multiple files • Up to 100 MB each","backBtn":"Back to All Tools","processBtn":"Process PDF","readyTitle":"File is ready!","readySub":"Your file is ready to download.","downloadBtn":"Download File","resetBtn":"Convert Another File","footerCopy":"© 2026 PDFAxiom. Free • No signup required.","extTitle":"PDFAxiom for Chrome","extSub":"Your tools one click away, in every tab.","extBtn":"Add to Chrome"},"hi":{"heroTitle":"PDFAXIOM ऑल इन वन","heroDesc":"सेकंडों में अपनी पीडीएफ फाइलों को कनवर्ट, एडिट, कंप्रेस और सुरक्षित करें, बिना साइनअप के।","heroSubtext":"","navConvert":"पीडीएफ कन्वर्ट करें","navMergeSplit":"मर्ज और स्प्लिट","navEdit":"संपादन और सुरक्षा","navCompress":"पीडीएफ कंप्रेस करें","navImages":"इमेज टूल्स","mobileMenu":"टूल्स","mobileClose":"बंद करें","tabAll":"सभी टूल्स","tabConvert":"कन्वर्ट और ऑफिस","tabOrganize":"मर्ज और व्यवस्थित करें","tabSecurity":"सुरक्षा और संपादन","dragTitle":"फ़ाइलों को यहाँ ड्रैग और ड्रॉप करें","dragSub":"कई फ़ाइलें • प्रत्येक 100 MB तक","backBtn":"सभी टूल्स पर वापस जाएं","processBtn":"पीडीएफ प्रोसेस करें","readyTitle":"फ़ाइल तैयार है!","readySub":"आपकी फ़ाइल डाउनलोड के लिए तैयार है।","downloadBtn":"फ़ाइल डाउनलोड करें","resetBtn":"दूसरी फ़ाइल बदलें","footerCopy":"© 2026 PDFAxiom. मुफ़्त • बिना पंजीकरण।","extTitle":"Chrome के लिए PDFAxiom","extSub":"हर टैब में, आपके टूल एक क्लिक दूर।","extBtn":"Chrome में जोड़ें"}};
const toolTranslations = {"en":{"pdf-to-word":{"title":"PDF to Word","desc":"Convert PDF files to editable Word documents (.docx)."},"word-to-pdf":{"title":"Word to PDF","desc":"Convert Word documents (.docx) to PDF format."},"img-to-pdf":{"title":"Images to PDF","desc":"Convert JPG, PNG, WEBP images into a PDF document."},"pdf-to-img":{"title":"PDF to JPG / PNG","desc":"Extract PDF pages into high-resolution JPG or PNG images."},"merge":{"title":"Merge PDF","desc":"Combine multiple PDF files into one single document."},"compress":{"title":"Compress PDF","desc":"Reduce PDF file size while maintaining maximum quality."},"split":{"title":"Split PDF","desc":"Separate PDF pages or extract custom page ranges."},"delete-pages":{"title":"Delete Pages","desc":"Remove unwanted pages from a PDF document."},"pdf-to-excel":{"title":"PDF to Excel","desc":"Extract PDF tables into Excel (.xlsx / .csv)."},"excel-to-pdf":{"title":"Excel to PDF","desc":"Convert Excel spreadsheets (.xlsx) to PDF."},"pdf-to-pptx":{"title":"PDF to PowerPoint","desc":"Turn PDF pages into PowerPoint slides (.pptx)."},"pptx-to-pdf":{"title":"PowerPoint to PDF","desc":"Convert PowerPoint (.pptx) into PDF file."},"unlock":{"title":"Unlock PDF","desc":"Remove security passwords & restrictions from PDF."},"protect":{"title":"Protect PDF","desc":"Encrypt PDF with custom user password."},"rotate":{"title":"Rotate PDF","desc":"Rotate PDF pages 90°, 180°, or 270° degrees."},"page-numbers":{"title":"Page Numbers","desc":"Add page numbers into your PDF document header/footer."},"watermark":{"title":"Watermark PDF","desc":"Add custom text watermark across PDF pages."},"grayscale":{"title":"Grayscale PDF","desc":"Convert colored PDF documents into Black & White."},"pdf-to-html":{"title":"PDF to HTML","desc":"Convert PDF documents into web-ready HTML code."},"html-to-pdf":{"title":"HTML to PDF","desc":"Convert web HTML text code into a PDF file."},"pdf-to-md":{"title":"PDF to Markdown","desc":"Convert PDF into clean Markdown (.md) for LLMs & Notion."},"md-to-pdf":{"title":"Markdown to PDF","desc":"Convert Markdown (.md) files into styled PDF documents."},"pdf-to-text":{"title":"Extract Text","desc":"Extract plain raw text (.txt) content from PDF."},"extract-images":{"title":"Extract Images","desc":"Extract all embedded image assets inside PDF."}},"hi":{"pdf-to-word":{"title":"पीडीएफ से वर्ड","desc":"पीडीएफ फाइलों को वर्ड दस्तावेजों (.docx) में बदलें।"},"word-to-pdf":{"title":"वर्ड से पीडीएफ","desc":"वर्ड दस्तावेजों (.docx) को पीडीएफ में बदलें।"},"img-to-pdf":{"title":"इमेज से पीडीएफ","desc":"JPG, PNG, WEBP छवियों को पीडीएफ में बदलें।"},"pdf-to-img":{"title":"पीडीएफ से JPG / PNG","desc":"पीडीएफ पेजों को उच्च गुणवत्ता वाले चित्रों में निकालें।"},"merge":{"title":"मर्ज पीडीएफ","desc":"कई पीडीएफ फाइलों को एक दस्तावेज में जोड़ें।"},"compress":{"title":"कंप्रेस पीडीएफ","desc":"गुणवत्ता बनाए रखते हुए पीडीएफ का आकार कम करें।"},"split":{"title":"स्प्लिट पीडीएफ","desc":"पीडीएफ पेजों को अलग करें।"},"delete-pages":{"title":"पेज हटाएं","desc":"अवांछित पेजों को हटाएं।"},"pdf-to-excel":{"title":"पीडीएफ से एक्सेल","desc":"पीडीएफ तालिकाओं को एक्सेल (.xlsx / .csv) में निकालें।"},"excel-to-pdf":{"title":"एक्सेल से पीडीएफ","desc":"एक्सेल शीट्स (.xlsx) को पीडीएफ में बदलें।"},"pdf-to-pptx":{"title":"पीडीएफ से पावरपॉइंट","desc":"पीडीएफ को पावरपॉइंट पीपीटी में बदलें।"},"pptx-to-pdf":{"title":"पावरपॉइंट से पीडीएफ","desc":"पावरपॉइंट पीपीटी को पीडीएफ में बदलें।"},"unlock":{"title":"अनलॉक पीडीएफ","desc":"पासवर्ड सुरक्षा हटाएं।"},"protect":{"title":"सुरक्षित पीडीएफ","desc":"पासवर्ड से अपनी पीडीएफ को सुरक्षित करें।"},"rotate":{"title":"रोटेट पीडीएफ","desc":"पेजों को घुमाएं।"},"page-numbers":{"title":"पेज नंबर","desc":"पेज नंबर जोड़ें।"},"watermark":{"title":"वाटरमार्क","desc":"वाटरमार्क जोड़ें।"},"grayscale":{"title":"ब्लैक एंड व्हाइट पीडीएफ","desc":"पीडीएफ को ब्लैक एंड व्हाइट में बदलें।"},"pdf-to-html":{"title":"पीडीएफ से HTML","desc":"पीडीएफ को HTML में बदलें।"},"html-to-pdf":{"title":"HTML से पीडीएफ","desc":"HTML कोड को पीडीएफ में बदलें।"},"pdf-to-md":{"title":"पीडीएफ से मार्कडाउन","desc":"पीडीएफ को मार्कडाउन (.md) में बदलें।"},"md-to-pdf":{"title":"मार्कडाउन से पीडीएफ","desc":"मार्कडाउन को पीडीएफ में बदलें।"},"pdf-to-text":{"title":"टेक्स्ट निकालें","desc":"पीडीएफ से टेक्स्ट निकालें।"},"extract-images":{"title":"इमेज निकालें","desc":"पीडीएफ से सभी तस्वीरें निकालें।"}}};
const toolButtons = {"en":{"pdf-to-word":"Convert PDF to Word","word-to-pdf":"Convert Word to PDF","pdf-to-md":"Convert PDF to Markdown","md-to-pdf":"Convert Markdown to PDF","merge":"Merge PDFs","pdf-to-img":"Convert to Images","img-to-pdf":"Create PDF","compress":"Compress PDF","split":"Split PDF","pdf-to-excel":"Convert to Excel","excel-to-pdf":"Convert Excel to PDF","pdf-to-pptx":"Convert to PowerPoint","pptx-to-pdf":"Convert PowerPoint to PDF","page-numbers":"Add Page Numbers","rotate":"Rotate PDF","unlock":"Unlock PDF","delete-pages":"Delete Pages","pdf-to-html":"Convert to HTML","html-to-pdf":"Convert HTML to PDF","grayscale":"Convert to Grayscale","extract-images":"Extract Images","pdf-to-text":"Extract Text","protect":"Protect PDF","watermark":"Add Watermark"},"hi":{"pdf-to-word":"PDF को Word में बदलें","word-to-pdf":"Word को PDF में बदलें","pdf-to-md":"PDF को Markdown में बदलें","md-to-pdf":"Markdown को PDF में बदलें","merge":"PDF जोड़ें","pdf-to-img":"छवियों में बदलें","img-to-pdf":"PDF बनाएँ","compress":"PDF छोटा करें","split":"PDF अलग करें","pdf-to-excel":"Excel में बदलें","excel-to-pdf":"Excel को PDF में बदलें","pdf-to-pptx":"PowerPoint में बदलें","pptx-to-pdf":"PowerPoint को PDF में बदलें","page-numbers":"पेज नंबर जोड़ें","rotate":"PDF घुमाएँ","unlock":"PDF अनलॉक करें","delete-pages":"पेज हटाएँ","pdf-to-html":"HTML में बदलें","html-to-pdf":"HTML को PDF में बदलें","grayscale":"श्वेत-श्याम में बदलें","extract-images":"छवियाँ निकालें","pdf-to-text":"टेक्स्ट निकालें","protect":"PDF सुरक्षित करें","watermark":"वॉटरमार्क जोड़ें"}};
const uiMessages = {"en":{"errGenerico":"Something went wrong. Please try again.","menuDaPdf":"CONVERT FROM PDF","menuAPdf":"CONVERT TO PDF","chiSiamo":"About Us","missioneTitolo":"Our Mission","missioneTesto":"PDFAxiom offers a free PDF suite, accessible from any device without registration.","privacyTitolo":"How we handle your files","privacyTesto":"Most tools process your documents directly in your browser: those files never leave your device. The heavier conversions (Word, Excel, PowerPoint, HTML, compression, protection) run on our servers: the file is processed and deleted immediately afterwards, never stored or shared.","contattiTitolo":"Contact &amp; Support","contattiTesto":"Have questions, suggestions, or requests? Write to us at {email}.","badgePopolare":"POPULAR","badgeOffice":"OFFICE","badgeSlides":"SLIDES","badgeAi":"AI READY","badgeImmagini":"IMAGES","pubblicita":"ADVERTISEMENT","pubblicitaBreve":"AD","piedeGratis":"Free • No signup required.","piedePrivacy":"Privacy","piedeTermini":"Terms","impCompressione":"Compression level","impLeggera":"Light","impLeggeraNota":"Keeps print quality","impMedia":"Balanced","impMediaNota":"Great for print &amp; sharing","impMassima":"Maximum","impMassimaNota":"Smallest file, screen &amp; email","impConsigliata":"Recommended","impPagineEstrai":"Pages to extract (e.g. 1-3, 5)","impPagineElimina":"Pages to delete (e.g. 1, 3)","impPasswordNuova":"Set PDF password","impPasswordAttuale":"Current PDF password","impPasswordSegno":"Enter password","impFiligrana":"Watermark text","rotLabel":"Rotation","rot90r":"90&deg; right","rot90rNota":"Quarter turn clockwise","rot180":"180&deg;","rot180Nota":"Upside down","rot90l":"90&deg; left","rot90lNota":"Quarter turn anticlockwise","numLabel":"Number format","numSolo":"Number only","numSoloNota":"1, 2, 3…","numTotale":"With total","numTotaleNota":"Shows how many","numTrattini":"Dashes","numTrattiniNota":"Classic book style","numEsteso":"Spelled out","numEstesoNota":"In English","uploading":"Uploading file...","processing":"Converting... {s}s","done":"Completed","processingFiles":"Processing files...","merging":"Merging PDF files... {s}%","fromImages":"Creating PDF from images... {s}%","batch":"Converting file {i} of {n}: {name}","zipping":"Creating ZIP package...","success":"Conversion completed successfully!","errTooBig":"File too large ({size}). The limit is 100 MB.","errNetwork":"Could not reach the conversion server.","errTimeout":"The server took too long. Try a smaller file.","errServer":"Server error ({code}).","errRate":"Too many requests. Wait a minute and try again.","errFormat":"The file content does not match the expected format.","errFailed":"Conversion failed: the file may be damaged or protected.","errUnavailable":"Conversion service temporarily unavailable.","errPassword":"Please enter a password.","errFileVuoto":"The file is empty.","errPasswordErrata":"Wrong password.","errTroppePagine":"The document is too long. The limit is 400 pages — split it first and convert the parts.","errPdfIlleggibile":"This PDF cannot be read. It may be damaged or password-protected.","errNessunaTabella":"No table was found in this PDF. Tables drawn without lines are the hardest to detect.","reading":"Reading the file...","working":"Processing...","generating":"Generating the document...","packaging":"Packaging the file...","completed":"Completed!","pageOf":"Page {i} of {n}...","fileOf":"File {i} of {n}..."},"hi":{"errGenerico":"कुछ गड़बड़ हो गई। दोबारा कोशिश करें।","menuDaPdf":"PDF से बदलें","menuAPdf":"PDF में बदलें","chiSiamo":"हमारे बारे में","missioneTitolo":"हमारा उद्देश्य","missioneTesto":"PDFAxiom एक मुफ़्त PDF टूल सूट है, जो किसी भी डिवाइस से और बिना पंजीकरण के उपलब्ध है।","privacyTitolo":"हम आपकी फ़ाइलों को कैसे संभालते हैं","privacyTesto":"ज़्यादातर टूल आपके ब्राउज़र में ही दस्तावेज़ प्रोसेस करते हैं: वे फ़ाइलें आपका डिवाइस कभी नहीं छोड़तीं। भारी रूपांतरण (Word, Excel, PowerPoint, HTML, कंप्रेशन, सुरक्षा) हमारे सर्वर पर चलते हैं: फ़ाइल प्रोसेस होने के तुरंत बाद हटा दी जाती है, न रखी जाती है न साझा की जाती है।","contattiTitolo":"संपर्क और सहायता","contattiTesto":"सवाल, सुझाव या अनुरोध? हमें {email} पर लिखें।","badgePopolare":"लोकप्रिय","badgeOffice":"OFFICE","badgeSlides":"स्लाइड","badgeAi":"AI के लिए","badgeImmagini":"छवियाँ","pubblicita":"विज्ञापन","pubblicitaBreve":"विज्ञ.","piedeGratis":"मुफ़्त • पंजीकरण की ज़रूरत नहीं।","piedePrivacy":"गोपनीयता","piedeTermini":"शर्तें","impCompressione":"कंप्रेशन स्तर","impLeggera":"हल्का","impLeggeraNota":"प्रिंट गुणवत्ता बनी रहती है","impMedia":"संतुलित","impMediaNota":"प्रिंट और साझा करने के लिए","impMassima":"अधिकतम","impMassimaNota":"सबसे छोटी फ़ाइल, स्क्रीन और ईमेल","impConsigliata":"अनुशंसित","impPagineEstrai":"निकालने वाले पेज (जैसे 1-3, 5)","impPagineElimina":"हटाने वाले पेज (जैसे 1, 3)","impPasswordNuova":"PDF पासवर्ड सेट करें","impPasswordAttuale":"मौजूदा PDF पासवर्ड","impPasswordSegno":"पासवर्ड दर्ज करें","impFiligrana":"वॉटरमार्क का पाठ","rotLabel":"घुमाव","rot90r":"90&deg; दाएँ","rot90rNota":"घड़ी की दिशा में चौथाई मोड़","rot180":"180&deg;","rot180Nota":"उल्टा","rot90l":"90&deg; बाएँ","rot90lNota":"उल्टी दिशा में चौथाई मोड़","numLabel":"नंबर का प्रारूप","numSolo":"केवल संख्या","numSoloNota":"1, 2, 3…","numTotale":"कुल के साथ","numTotaleNota":"कितने हैं दिखाता है","numTrattini":"डैश के बीच","numTrattiniNota":"किताब जैसी शैली","numEsteso":"पूरे शब्दों में","numEstesoNota":"अंग्रेछ़ी में","uploading":"फ़ाइल अपलोड हो रही है...","processing":"रूपांतरण जारी... {s} सेकंड","done":"पूर्ण","processingFiles":"फ़ाइलें संसाधित हो रही हैं...","merging":"PDF जोड़े जा रहे हैं... {s}%","fromImages":"छवियों से PDF बन रहा है... {s}%","batch":"फ़ाइल {i}/{n} रूपांतरित हो रही है: {name}","zipping":"ZIP पैकेज बन रहा है...","success":"रूपांतरण सफलतापूर्वक पूर्ण हुआ!","errTooBig":"फ़ाइल बहुत बड़ी है ({size})। सीमा 100 MB है।","errNetwork":"रूपांतरण सर्वर से संपर्क नहीं हो सका।","errTimeout":"सर्वर ने बहुत समय लिया। छोटी फ़ाइल आज़माएँ।","errServer":"सर्वर त्रुटि ({code})।","errRate":"बहुत अधिक अनुरोध। एक मिनट प्रतीक्षा करें।","errFormat":"फ़ाइल की सामग्री अपेक्षित प्रारूप से मेल नहीं खाती।","errFailed":"रूपांतरण विफल: फ़ाइल क्षतिग्रस्त या सुरक्षित हो सकती है।","errUnavailable":"रूपांतरण सेवा अस्थायी रूप से अनुपलब्ध है।","errPassword":"कृपया पासवर्ड दर्ज करें।","errFileVuoto":"फ़ाइल खाली है।","errPasswordErrata":"गलत पासवर्ड।","errTroppePagine":"दस्तावेज़ बहुत लंबा है। सीमा 400 पृष्ठ है — पहले बाँटें और हिस्से अलग-अलग बदलें।","errPdfIlleggibile":"यह PDF पढ़ी नहीं जा सकती। यह क्षतिग्रस्त या पासवर्ड से सुरक्षित हो सकती है।","errNessunaTabella":"इस PDF में कोई तालिका नहीं मिली। बिना रेखाओं वाली तालिकाएँ पहचानना सबसे कठिन है।","reading":"फ़ाइल पढ़ी जा रही है...","working":"प्रक्रिया जारी है...","generating":"दस्तावेज़ बनाया जा रहा है...","packaging":"फ़ाइल बनाई जा रही है...","completed":"पूर्ण!","pageOf":"पृष्ठ {i} / {n}...","fileOf":"फ़ाइल {i} / {n}..."}};
