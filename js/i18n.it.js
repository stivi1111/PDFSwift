/* Generato da build/genera.js: le traduzioni per "it".
   Non modificarlo a mano, le traduzioni stanno in js/i18n.js. */
const LINGUE_PDFAXIOM = ["en","it","es","de","zh","ro","hi","ru"];

const translations = {"en":{"heroTitle":"PDFAXIOM All in One","heroDesc":"Convert, edit, compress and secure your PDF files in seconds, no signup needed.","heroSubtext":"","navConvert":"Convert PDF","navMergeSplit":"Merge & Split","navEdit":"Edit & Security","navCompress":"Compress PDF","navImages":"Image Tools","mobileMenu":"Tools","mobileClose":"Close","tabAll":"All Tools","tabConvert":"Convert & Office","tabOrganize":"Merge & Organize","tabSecurity":"Security & Edit","dragTitle":"Drag & Drop files here","dragSub":"Multiple files • Up to 100 MB each","backBtn":"Back to All Tools","processBtn":"Process PDF","readyTitle":"File is ready!","readySub":"Your file is ready to download.","downloadBtn":"Download File","resetBtn":"Convert Another File","footerCopy":"© 2026 PDFAxiom. Free • No signup required.","extTitle":"PDFAxiom for Chrome","extSub":"Your tools one click away, in every tab.","extBtn":"Add to Chrome"},"it":{"heroTitle":"PDFAXIOM Tutto in Uno","heroDesc":"Converti, modifica, comprimi e proteggi i tuoi file PDF in pochi secondi, senza registrazione.","heroSubtext":"","navConvert":"Converti PDF","navMergeSplit":"Unisci e Dividi","navEdit":"Modifica & Sicurezza","navCompress":"Comprimi PDF","navImages":"Strumenti Immagini","mobileMenu":"Strumenti","mobileClose":"Chiudi","tabAll":"Tutti i Tool","tabConvert":"Conversione & Office","tabOrganize":"Unisci & Organizza","tabSecurity":"Sicurezza & Modifica","dragTitle":"Trascina qui i tuoi file","dragSub":"Più file • Fino a 100 MB ciascuno","backBtn":"Torna a Tutti i Tool","processBtn":"Elabora PDF","readyTitle":"Il file è pronto!","readySub":"Il tuo file è pronto per il download.","downloadBtn":"Scarica File","resetBtn":"Converti un Altro File","footerCopy":"© 2026 PDFAxiom. Gratuito • Nessuna registrazione.","extTitle":"PDFAxiom per Chrome","extSub":"I tuoi strumenti a un clic, in ogni scheda.","extBtn":"Aggiungi a Chrome"}};
const toolTranslations = {"en":{"pdf-to-word":{"title":"PDF to Word","desc":"Convert PDF files to editable Word documents (.docx)."},"word-to-pdf":{"title":"Word to PDF","desc":"Convert Word documents (.docx) to PDF format."},"img-to-pdf":{"title":"Images to PDF","desc":"Convert JPG, PNG, WEBP images into a PDF document."},"pdf-to-img":{"title":"PDF to JPG / PNG","desc":"Extract PDF pages into high-resolution JPG or PNG images."},"merge":{"title":"Merge PDF","desc":"Combine multiple PDF files into one single document."},"compress":{"title":"Compress PDF","desc":"Reduce PDF file size while maintaining maximum quality."},"split":{"title":"Split PDF","desc":"Separate PDF pages or extract custom page ranges."},"delete-pages":{"title":"Delete Pages","desc":"Remove unwanted pages from a PDF document."},"pdf-to-excel":{"title":"PDF to Excel","desc":"Extract PDF tables into Excel (.xlsx / .csv)."},"excel-to-pdf":{"title":"Excel to PDF","desc":"Convert Excel spreadsheets (.xlsx) to PDF."},"pdf-to-pptx":{"title":"PDF to PowerPoint","desc":"Turn PDF pages into PowerPoint slides (.pptx)."},"pptx-to-pdf":{"title":"PowerPoint to PDF","desc":"Convert PowerPoint (.pptx) into PDF file."},"unlock":{"title":"Unlock PDF","desc":"Remove security passwords & restrictions from PDF."},"protect":{"title":"Protect PDF","desc":"Encrypt PDF with custom user password."},"rotate":{"title":"Rotate PDF","desc":"Rotate PDF pages 90°, 180°, or 270° degrees."},"page-numbers":{"title":"Page Numbers","desc":"Add page numbers into your PDF document header/footer."},"watermark":{"title":"Watermark PDF","desc":"Add custom text watermark across PDF pages."},"grayscale":{"title":"Grayscale PDF","desc":"Convert colored PDF documents into Black & White."},"pdf-to-html":{"title":"PDF to HTML","desc":"Convert PDF documents into web-ready HTML code."},"html-to-pdf":{"title":"HTML to PDF","desc":"Convert web HTML text code into a PDF file."},"pdf-to-md":{"title":"PDF to Markdown","desc":"Convert PDF into clean Markdown (.md) for LLMs & Notion."},"md-to-pdf":{"title":"Markdown to PDF","desc":"Convert Markdown (.md) files into styled PDF documents."},"pdf-to-text":{"title":"Extract Text","desc":"Extract plain raw text (.txt) content from PDF."},"extract-images":{"title":"Extract Images","desc":"Extract all embedded image assets inside PDF."}},"it":{"pdf-to-word":{"title":"Da PDF a Word","desc":"Converti file PDF in documenti Word modificabili (.docx)."},"word-to-pdf":{"title":"Da Word a PDF","desc":"Converti documenti Word (.docx) in formato PDF."},"img-to-pdf":{"title":"Da Immagini a PDF","desc":"Converti immagini JPG, PNG, WEBP in un documento PDF."},"pdf-to-img":{"title":"Da PDF a JPG / PNG","desc":"Estrai le pagine del PDF in immagini ad alta risoluzione."},"merge":{"title":"Unisci PDF","desc":"Combina più file PDF in un unico documento."},"compress":{"title":"Comprimi PDF","desc":"Riduci la dimensione del PDF mantenendo la massima qualità."},"split":{"title":"Dividi PDF","desc":"Separa le pagine del PDF o estrai intervalli personalizzati."},"delete-pages":{"title":"Elimina Pagine","desc":"Rimuovi le pagine indesiderate da un documento PDF."},"pdf-to-excel":{"title":"Da PDF a Excel","desc":"Estrai tabelle PDF in fogli Excel (.xlsx / .csv)."},"excel-to-pdf":{"title":"Da Excel a PDF","desc":"Converti fogli di calcolo Excel (.xlsx) in PDF."},"pdf-to-pptx":{"title":"Da PDF a PowerPoint","desc":"Trasforma pagine PDF in diapositive PowerPoint (.pptx)."},"pptx-to-pdf":{"title":"Da PowerPoint a PDF","desc":"Converti presentazioni PowerPoint (.pptx) in PDF."},"unlock":{"title":"Sblocca PDF","desc":"Rimuovi password di protezione e restrizioni dai PDF."},"protect":{"title":"Proteggi PDF","desc":"Crittografa il tuo PDF con una password personalizzata."},"rotate":{"title":"Ruota PDF","desc":"Ruota le pagine del PDF di 90°, 180° o 270°."},"page-numbers":{"title":"Numeri di Pagina","desc":"Aggiungi numeri di pagina nell’intestazione o piè di pagina."},"watermark":{"title":"Filigrana PDF","desc":"Aggiungi un testo di filigrana personalizzato sulle pagine."},"grayscale":{"title":"PDF in Bianco e Nero","desc":"Converti i PDF a colori in formato Bianco e Nero (Grayscale)."},"pdf-to-html":{"title":"Da PDF a HTML","desc":"Converti documenti PDF in codice web HTML."},"html-to-pdf":{"title":"Da HTML a PDF","desc":"Converti codice testo HTML in un file PDF."},"pdf-to-md":{"title":"Da PDF a Markdown","desc":"Converti PDF in testo pulito Markdown (.md) per AI & Notion."},"md-to-pdf":{"title":"Da Markdown a PDF","desc":"Converti file Markdown (.md) in documenti PDF stilizzati."},"pdf-to-text":{"title":"Estrai Testo","desc":"Estrai il contenuto di testo puro (.txt) dal PDF."},"extract-images":{"title":"Estrai Immagini","desc":"Estrai tutte le immagini incorporate all’interno del PDF."}}};
const toolButtons = {"en":{"pdf-to-word":"Convert PDF to Word","word-to-pdf":"Convert Word to PDF","pdf-to-md":"Convert PDF to Markdown","md-to-pdf":"Convert Markdown to PDF","merge":"Merge PDFs","pdf-to-img":"Convert to Images","img-to-pdf":"Create PDF","compress":"Compress PDF","split":"Split PDF","pdf-to-excel":"Convert to Excel","excel-to-pdf":"Convert Excel to PDF","pdf-to-pptx":"Convert to PowerPoint","pptx-to-pdf":"Convert PowerPoint to PDF","page-numbers":"Add Page Numbers","rotate":"Rotate PDF","unlock":"Unlock PDF","delete-pages":"Delete Pages","pdf-to-html":"Convert to HTML","html-to-pdf":"Convert HTML to PDF","grayscale":"Convert to Grayscale","extract-images":"Extract Images","pdf-to-text":"Extract Text","protect":"Protect PDF","watermark":"Add Watermark"},"it":{"pdf-to-word":"Converti PDF in Word","word-to-pdf":"Converti Word in PDF","pdf-to-md":"Converti PDF in Markdown","md-to-pdf":"Converti Markdown in PDF","merge":"Unisci i PDF","pdf-to-img":"Converti in immagini","img-to-pdf":"Crea il PDF","compress":"Comprimi il PDF","split":"Dividi il PDF","pdf-to-excel":"Converti in Excel","excel-to-pdf":"Converti Excel in PDF","pdf-to-pptx":"Converti in PowerPoint","pptx-to-pdf":"Converti PowerPoint in PDF","page-numbers":"Aggiungi i numeri di pagina","rotate":"Ruota il PDF","unlock":"Sblocca il PDF","delete-pages":"Elimina le pagine","pdf-to-html":"Converti in HTML","html-to-pdf":"Converti HTML in PDF","grayscale":"Converti in bianco e nero","extract-images":"Estrai le immagini","pdf-to-text":"Estrai il testo","protect":"Proteggi il PDF","watermark":"Aggiungi la filigrana"}};
const uiMessages = {"en":{"errGenerico":"Something went wrong. Please try again.","menuDaPdf":"CONVERT FROM PDF","menuAPdf":"CONVERT TO PDF","chiSiamo":"About Us","missioneTitolo":"Our Mission","missioneTesto":"PDFAxiom offers a free PDF suite, accessible from any device without registration.","privacyTitolo":"How we handle your files","privacyTesto":"Most tools process your documents directly in your browser: those files never leave your device. The heavier conversions (Word, Excel, PowerPoint, HTML, compression, protection) run on our servers: the file is processed and deleted immediately afterwards, never stored or shared.","contattiTitolo":"Contact &amp; Support","contattiTesto":"Have questions, suggestions, or requests? Write to us at {email}.","badgePopolare":"POPULAR","badgeOffice":"OFFICE","badgeSlides":"SLIDES","badgeAi":"AI READY","badgeImmagini":"IMAGES","pubblicita":"ADVERTISEMENT","pubblicitaBreve":"AD","piedeGratis":"Free • No signup required.","piedePrivacy":"Privacy","piedeTermini":"Terms","impCompressione":"Compression level","impLeggera":"Light","impLeggeraNota":"Keeps print quality","impMedia":"Balanced","impMediaNota":"Great for print &amp; sharing","impMassima":"Maximum","impMassimaNota":"Smallest file, screen &amp; email","impConsigliata":"Recommended","impPagineEstrai":"Pages to extract (e.g. 1-3, 5)","impPagineElimina":"Pages to delete (e.g. 1, 3)","impPasswordNuova":"Set PDF password","impPasswordAttuale":"Current PDF password","impPasswordSegno":"Enter password","impFiligrana":"Watermark text","rotLabel":"Rotation","rot90r":"90&deg; right","rot90rNota":"Quarter turn clockwise","rot180":"180&deg;","rot180Nota":"Upside down","rot90l":"90&deg; left","rot90lNota":"Quarter turn anticlockwise","numLabel":"Number format","numSolo":"Number only","numSoloNota":"1, 2, 3…","numTotale":"With total","numTotaleNota":"Shows how many","numTrattini":"Dashes","numTrattiniNota":"Classic book style","numEsteso":"Spelled out","numEstesoNota":"In English","uploading":"Uploading file...","processing":"Converting... {s}s","done":"Completed","processingFiles":"Processing files...","merging":"Merging PDF files... {s}%","fromImages":"Creating PDF from images... {s}%","batch":"Converting file {i} of {n}: {name}","zipping":"Creating ZIP package...","success":"Conversion completed successfully!","errTooBig":"File too large ({size}). The limit is 100 MB.","errNetwork":"Could not reach the conversion server.","errTimeout":"The server took too long. Try a smaller file.","errServer":"Server error ({code}).","errRate":"Too many requests. Wait a minute and try again.","errFormat":"The file content does not match the expected format.","errFailed":"Conversion failed: the file may be damaged or protected.","errUnavailable":"Conversion service temporarily unavailable.","errPassword":"Please enter a password.","errFileVuoto":"The file is empty.","errPasswordErrata":"Wrong password.","errTroppePagine":"The document is too long. The limit is 400 pages — split it first and convert the parts.","errPdfIlleggibile":"This PDF cannot be read. It may be damaged or password-protected.","errNessunaTabella":"No table was found in this PDF. Tables drawn without lines are the hardest to detect.","reading":"Reading the file...","working":"Processing...","generating":"Generating the document...","packaging":"Packaging the file...","completed":"Completed!","pageOf":"Page {i} of {n}...","fileOf":"File {i} of {n}..."},"it":{"errGenerico":"Qualcosa è andato storto. Riprova.","menuDaPdf":"CONVERTI DA PDF","menuAPdf":"CONVERTI IN PDF","chiSiamo":"Chi siamo","missioneTitolo":"La nostra missione","missioneTesto":"PDFAxiom nasce per offrire una suite di strumenti PDF gratuita, accessibile da qualsiasi dispositivo e senza registrazione.","privacyTitolo":"Come trattiamo i tuoi file","privacyTesto":"Gran parte degli strumenti elabora i documenti direttamente nel tuo browser: quei file non lasciano mai il tuo dispositivo. Le conversioni più complesse (Word, Excel, PowerPoint, HTML, compressione, protezione) vengono eseguite sui nostri server: il file viene elaborato e cancellato subito dopo, senza essere conservato né condiviso.","contattiTitolo":"Contatti e supporto","contattiTesto":"Hai domande, suggerimenti o richieste? Scrivici a {email}.","badgePopolare":"POPOLARE","badgeOffice":"OFFICE","badgeSlides":"DIAPOSITIVE","badgeAi":"PRONTO PER L’IA","badgeImmagini":"IMMAGINI","pubblicita":"PUBBLICITÀ","pubblicitaBreve":"ANN.","piedeGratis":"Gratis • Senza registrazione.","piedePrivacy":"Privacy","piedeTermini":"Condizioni","impCompressione":"Livello di compressione","impLeggera":"Leggera","impLeggeraNota":"Mantiene la qualità di stampa","impMedia":"Equilibrata","impMediaNota":"Buona per stampa e invio","impMassima":"Massima","impMassimaNota":"File più piccolo, schermo ed email","impConsigliata":"Consigliata","impPagineEstrai":"Pagine da estrarre (es. 1-3, 5)","impPagineElimina":"Pagine da eliminare (es. 1, 3)","impPasswordNuova":"Imposta la password del PDF","impPasswordAttuale":"Password attuale del PDF","impPasswordSegno":"Inserisci la password","impFiligrana":"Testo della filigrana","rotLabel":"Rotazione","rot90r":"90&deg; a destra","rot90rNota":"Un quarto di giro orario","rot180":"180&deg;","rot180Nota":"Sottosopra","rot90l":"90&deg; a sinistra","rot90lNota":"Un quarto di giro antiorario","numLabel":"Formato del numero","numSolo":"Solo il numero","numSoloNota":"1, 2, 3…","numTotale":"Con il totale","numTotaleNota":"Mostra quante sono","numTrattini":"Fra trattini","numTrattiniNota":"Stile libro","numEsteso":"Per esteso","numEstesoNota":"In inglese","uploading":"Caricamento file...","processing":"Conversione in corso... {s}s","done":"Completato","processingFiles":"Elaborazione file...","merging":"Unione dei PDF... {s}%","fromImages":"Creazione PDF dalle immagini... {s}%","batch":"Conversione file {i} di {n}: {name}","zipping":"Creazione pacchetto ZIP...","success":"Conversione completata con successo!","errTooBig":"File troppo grande ({size}). Il limite è 100 MB.","errNetwork":"Impossibile contattare il server di conversione.","errTimeout":"Il server ha impiegato troppo tempo. Riprova con un file più piccolo.","errServer":"Errore del server ({code}).","errRate":"Troppe richieste. Attendi un minuto e riprova.","errFormat":"Il contenuto del file non corrisponde al formato atteso.","errFailed":"Conversione non riuscita: il file potrebbe essere danneggiato o protetto.","errUnavailable":"Servizio di conversione temporaneamente non disponibile.","errPassword":"Inserisci una password.","errFileVuoto":"Il file è vuoto.","errPasswordErrata":"Password errata.","errTroppePagine":"Il documento è troppo lungo. Il limite è 400 pagine: dividilo e converti le parti.","errPdfIlleggibile":"Questo PDF non è leggibile. Potrebbe essere danneggiato o protetto da password.","errNessunaTabella":"Nessuna tabella trovata in questo PDF. Le tabelle senza righe disegnate sono le più difficili da riconoscere.","reading":"Lettura del file...","working":"Elaborazione in corso...","generating":"Generazione del documento...","packaging":"Creazione del file...","completed":"Completato!","pageOf":"Pagina {i} di {n}...","fileOf":"File {i} di {n}..."}};
